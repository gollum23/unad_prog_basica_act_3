                ...
                <div class="col-xs-4 col-xs-offset-4">
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            ...
                            ?>
                            <p>Los números elevados al cuadrado son:</p>
                            <?php

                            $my_square_array = array_map("square", $my_array);
                            foreach ($my_square_array as $square) {
                                ?>
                                <span><?=$square;?>, </span>
                                <?php
                            }
                ...
                &ltdiv class="col-xs-4 col-xs-offset-4"&gt
                    &ltdiv class="panel panel-success"&gt
                        ...
                        &ltdiv class="panel-body"&gt
                            ...
                            foreach ($my_array as $item) {
                                ?&gt
                                &ltspan&gt&lt?=$item;?&gt, &lt/span&gt
                                &lt?php
                            }
                            ?&gt
                            &ltp&gtLos números elevados al cuadrado son:&lt/p&gt
                            &lt?php

                            $my_square_array = array_map("square", $my_array);
                            foreach ($my_square_array as $square) {
                                ?&gt
                                &ltspan&gt&lt?=$square;?&gt, &lt/span&gt
                                &lt?php
                            }
                            ?&gt
                        &lt/div&gt
